<h1 align="center">
  🏠<br/>Home Assistant configuration for a smart-looking place!<br/> <sup><sub>by <a href="https://aaronegaas.com/">Aaron Egaas</a> 😃</sub></sup> forked from <a href="https://aegaas.com/">René-Marc imard</a> 
</h1>
...
- **[Doomsday Clock](https://github.com/aegaas/home-assistant-doomsday-clock)** in case egocentric psychopaths keep on playing Russian roulette with humanity's future.
...
<div align="center">
    <figure>
        ...
        <figcaption>
            <p><strong>Technology diagram (<a href="www/images/technology-diagram.png"><code>PNG</code></a>, <a href="www/images/technology-diagram.svg"><code>SVG</code></a>). Made with <a href="https://www.draw.io/?title=Home%20Assistant%20Technology%20Diagram.xml#Uhttps%3A%2F%2Fgithub.com%2Faegaas%2Fhome-assistant-config%2Fraw%2Fmaster%2Fwww%2Fimages%2Ftechnology-diagram.xml">Draw.io</a> (<a href="www/images/technology-diagram.xml"><code>XML</code></a> source file).</strong></p>
        </figcaption>
    </figure>
</div>
...
- **[Raspberry Pi Zero W](https://www.raspberrypi.org/products/raspberry-pi-zero-w/)** (x3), each managed through [resin.io](https://resin.io/) to run as simple, dedicated plug-in bridges for the following services:
    1. **[Airthings Wave radon detector bridge](https://github.com/aegaas/balena-airthingswave)** running [airthingswave-mqtt](https://github.com/hpeyerl/airthingswave-mqtt) by Herb Peyerl (**[@hpeyerl](https://github.com/hpeyerl)**) in order to interface with [this Bluetooth radon detector](https://airthings.com/wave/).
    ...
    3. **[Flic smart button bridge](https://github.com/aegaas/balena-flic)** to connect with [these Bluetooth Low Energy buttons](https://flic.io/).
...
- **[Doomsday Clock component](https://github.com/aegaas/home-assistant-doomsday-clock)** to track how close humanity is to a man-made global catastrophe.
...
```shell
git clone --recurse-submodules git@github.com:aegaas/home-assistant-config.git .
...
[img-release]:https://img.shields.io/github/release/aegaas/home-assistant-config/all.svg?logo=github&logoColor=white&maxAge=21600
[img-travis-ci]:https://img.shields.io/travis/aegaas/home-assistant-config.svg?branch=master&logo=travis
[img-twitter]:https://img.shields.io/twitter/url/http/shields.io.svg?style=social&maxAge=86400

[link-board]:https://github.com/aegaas/home-assistant-config/projects/1
[link-ha-version]:https://github.com/home-assistant/home-assistant/tree/0.84.3
[link-hassio]:https://home-assistant.io/hassio/
[link-issues]:https://github.com/aegaas/home-assistant-config/issues
[link-license]:LICENSE.txt
[link-release]:https://github.com/aegaas/home-assistant-config/releases
[link-travis-ci]:https://travis-ci.org/aegaas/home-assistant-config
[link-twitter]:https://twitter.com/intent/tweet?text=Automate%20your%20home%20into%20a%20smart-looking%20place!&url=https://github.com/aegaas/home-assistant-config&via=aegaas&hashtags=HomeAssistant,SmartHome,ConnectedHome,HomeAutomation,IoT
